...
//                .cors(cors -> cors.configurationSource(corsConfigurationSource()))
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Payment-service reads passengers for booking confirmation email (internal call)
                        .requestMatchers("GET", "/passengers/booking/**").hasAnyRole("PASSENGER", "AIRLINE_STAFF")
                        .requestMatchers("GET", "/passengers/**").hasAnyRole("PASSENGER", "AIRLINE_STAFF")
